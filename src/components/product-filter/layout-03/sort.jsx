            ...
            <div className="inner">
                ...
                <div className="content">
                    <div className="nuron-form-check">
                        ...
                        />
                        <label htmlFor="short-check1">Más nuevo</label>
                    </div>
                    <div className="nuron-form-check">
                        <input
                            type="radio"
                            ...
                            onChange={changeHandler}
                        />
                        <label htmlFor="short-check2">más antiguo</label>
                    </div>
                    <div className="nuron-form-check">
                        <input
                            type="radio"
                            ...
                            onChange={changeHandler}
                        />
                        <label htmlFor="short-check3">Más gustado</label>
                    </div>
                    <div className="nuron-form-check">
                        <input
                            type="radio"
                            ...
                            onChange={changeHandler}
                        />
                        <label htmlFor="short-check4">Menos gustado</label>
                    </div>
                </div>
            </div>
        </div>
